...
# Generated by iptables-save v1.4.21 on Sat Mar 17 04:18:27 2018
*nat
:PREROUTING ACCEPT [0:0]
:INPUT ACCEPT [0:0]
:OUTPUT ACCEPT [89:6081]
:POSTROUTING ACCEPT [89:6081]
:DOCKER - [0:0]
...
COMMIT
# Completed on Sat Mar 17 04:18:27 2018
# Generated by iptables-save v1.4.21 on Sat Mar 17 04:18:27 2018
*filter
:INPUT ACCEPT [0:0]
:FORWARD DROP [0:0]
...
# Generated by iptables-save v1.4.21 on Sat Mar 17 04:18:27 2018
*security
:INPUT ACCEPT [108396:149435240]
:FORWARD ACCEPT [0:0]
:OUTPUT ACCEPT [19900:2497746]
...
for unit in atomic-openshift-node.service; do
	systemctl enable $unit
	systemctl start $unit
done
